angular.module("locator", []), angular.module("locator").directive("locationLookup", [function() {
    ...
    r.getDetails({
     ...
     e.$apply(function() {
      ...
      var a = {
       ...
       city: t.address_components[1].long_name,
       state: t.address_components[2].long_name,
 ...
 return {
  ...
  template: '<input type="text" id="locator-input" placeholder="Busca tu Dirección">',
  link: function(e, o) {
  ...
  link: function(n, a, r, i) {
   n.limitTo = n.$eval(r.limitTo) || 15, o.ready(function() {
    ...
    var e = {
     ...
     city: e.address_components[3].long_name,
     state: e.address_components[4].long_name,
